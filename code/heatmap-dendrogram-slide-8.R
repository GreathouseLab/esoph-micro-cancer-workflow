...
p <- plot_grid(plt_dendr, plt_hmap0, plt_hmap1, plt_hmap2,plt_hmap3, align = 'h', rel_widths = c(0.3, 0.2, 1, 1.2, 1),ncol = 5)
p
ggsave("output/slide-8-heatmap.pdf", plot=p, units="in", width=20, height=8)
ggsave("output/slide-8-heatmap.png", plot=p, units="in", width=20, height=8)
