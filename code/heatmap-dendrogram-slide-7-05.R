...
plot.dat <- dat.wgs %>% filter(sample_type != "0", Abundance > 0.05) %>%
...
p
ggsave("output/slide-7-heatmap-05.pdf", plot=p, units="in", width=15, height=8)
ggsave("output/slide-7-heatmap-05.png", plot=p, units="in", width=15, height=8)
