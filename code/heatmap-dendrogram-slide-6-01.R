...
plot.dat <- dat.rna %>% filter(sample_type != "0", Abundance > 0.01) %>%
...
p <- plot_grid(plt_dendr, plt_hmap1, plt_hmap2,plt_hmap3, align = 'h', rel_widths = c(0.5, 0.4, 0.15, 1),ncol = 4)
p
ggsave("output/slide-6-heatmap-01.pdf", plot=p, units="in", width=15, height=8)
ggsave("output/slide-6-heatmap-01.png", plot=p, units="in", width=15, height=8)
