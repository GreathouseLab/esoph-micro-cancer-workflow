...
dat.16s$tumor.stage <- dat.16s$pTNM
dat.16s$tumor.stage[dat.16s$pTNM == "IIA"] <- "II"
dat.16s$tumor.stage[dat.16s$pTNM == "IIB"] <- "II"
dat.16s$tumor.stage <- factor(dat.16s$tumor.stage, c("0", "1", "I", "II", "III", "IV"), ordered = T)

dat.rna$tumor.stage <- "0"
# dat.rna$tumor.stage <- recode(
#   dat.rna$tumor_stage,
#   `stage i` = "I", "stage ia" = "I", "stage ib" = "I",
#   "stage iia" = "II", "stage iib" = "II", "stageiib"= "II",
#   "stage iii" = "III", "stage iiia"= "III","stage iiib"= "III", "stage iiic"= "III",
#   "stage iv"="IV", "stage iva"="IV"
# )
# dat.16s$tumor.stage <- factor(
#   dat.16s$pTNM,
#   levels = rev(c("0", "1", "I", "IIA", "IIB", "III", "IV")),
#   lables = rev(c("0", "1", "I", "II", "II", "III", "IV")), ordered=T
# )
# 

dat.rna$tumor_stage <- -99
dat.wgs$tumor_stage <- -99
