...
#Violin Plot Fuso
```{r violin-fuso, warning=F, error=F, message=F}
...
#Violin Plot Strepto
```{r violin-strepto, warning=F, error=F, message=F}
...
#Violin Plot Campy
```{r violin-campy, warning=F, error=F, message=F}
...
#Violin Plot Prevo
```{r violin-prevo, warning=F, error=F, message=F}
