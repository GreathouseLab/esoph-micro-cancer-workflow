...
```{r ht-nci-species-lvl-data, include=FALSE, echo=FALSE, warning=F, error=F, message=F}
...
```{r ht-nci-species-lvl-05-plot, error=F, message=FALSE, warning=FALSE}
...
```{r ht-nci-species-lvl-05-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
```{r ht-nci-species-lvl-01-plot, warning=F, error=F, message=F}
...
```{r ht-nci-species-lvl-01-plot-make, warning=F, error=F, message=F, out.width="150%", out.height="500px"}
...
p
if(save.plots == T){
  ggsave(paste0("output/nci-species-lvl-heatmap-01-",save.Date,".pdf"), plot=p, units="in", width=11, height=7)
  ggsave(paste0("output/nci-species-lvl-heatmap-01-",save.Date,".png"), plot=p, units="in", width=11, height=7)
}
```
...
```{r ht-nci-otus-data, include=FALSE, echo=FALSE, warning=F, error=F, message=F}
...
```{r ht-nci-otus-05-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
if(save.plots == T){
  ggsave(paste0("output/nci-specific-otus-heatmap-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/nci-specific-otus-heatmap-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
```{r ht-tcga-rna-species-lvl-data, include=FALSE, echo=FALSE, warning=F, error=F, message=F}
...
```{r ht-tcga-rna-species-lvl-05-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-rna-species-lvl-05-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
if(save.plots == T){
  ggsave(paste0("output/tcga-rna-species-lvl-heatmap-05-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/tcga-rna-species-lvl-heatmap-05-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
```{r ht-tcga-rna-species-lvl-01-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-rna-species-lvl-01-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
if(save.plots == T){
  ggsave(paste0("output/tcga-rna-species-lvl-heatmap-01-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/tcga-rna-species-lvl-heatmap-01-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
```{r ht-tcga-rna-species-lvl-001-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-rna-species-lvl-001-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
if(save.plots == T){
  ggsave(paste0("output/tcga-rna-species-lvl-heatmap-001-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/tcga-rna-species-lvl-heatmap-001-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
The difference here is we focus on 4 OTUs.

```{r ht-tcga-rna-otus-data, include=FALSE, echo=FALSE, warning=F, error=F, message=F}
...
kable(otu.dat[,c(2,1)], format="html", digits=5) %>%
  kable_styling(full_width = T)%>%
  scroll_box(width="100%", height="100%")
...
plt_hmap3 <- ggplot(hmd, 
  ...
  geom_tile() +
  #facet_wrap(.~sample_type)+
  scale_fill_gradient2("Abundance",trans="sqrt", high = "darkblue", low = "white", breaks=c(0,0.001,0.01, 0.10)) +
  scale_x_continuous(breaks = spd$x_center, 
                     labels = spd$ID, 
                     expand = c(0, 0)) + 
  # For the y axis, alternatively set the labels as: gene_position_table$gene
...
```{r ht-tcga-rna-otus-05-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
if(save.plots == T){
  ggsave(paste0("output/tcga-rna-specific-otus-heatmap-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/tcga-rna-specific-otus-heatmap-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
```{r ht-tcga-wgs-species-lvl-data, include=FALSE, echo=FALSE, warning=F, error=F, message=F}
...
```{r ht-tcga-wgs-species-lvl-05-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-wgs-species-lvl-05-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
```{r ht-tcga-wgs-species-lvl-01-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-wgs-species-lvl-01-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
```{r ht-tcga-wgs-species-lvl-001-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-wgs-species-lvl-001-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
```{r ht-tcga-wgs-specific-otus-data, include=FALSE, echo=FALSE, warning=F, error=F, message=F}
...
```{r ht-tcga-wgs-specific-otus-plot, warning=F, error=F, message=F}
...
```{r ht-tcga-wgs-specific-otus-plot-make, warning=F, error=F, message=F, fig.height=5,out.width="100%", out.height="500px"}
...
if(save.plots == T){
  ggsave(paste0("output/tcga-wgs-specific-otus-heatmap-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/tcga-wgs-specific-otus-heatmap-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
