...
Prior to ESCAh heatmap will be a table of the OTUs that meet the given criteria.

I figured out that I originally subset based on the OTU relative abundance for ESCAh individual and sample, meaning that I subset according the just the raw *Abundance* irrespective of any OTU *average abundance*.
...
dat.rna$sample_type[(dat.rna$morphology=="8140/3" |
                      ...
                      dat.rna$Barrett.s.Esophagus.Reported=="Yes"] <- "ESCA tissues w/ Barretts History"
dat.rna$sample_type[(dat.rna$morphology=="8140/3" | 
                       dat.rna$morphology=="8480/3") &
                      dat.rna$SampleType_Level2=="Normal"&
                      dat.rna$Barrett.s.Esophagus.Reported=="Yes"] <- "ESCA-adjacent tissue w/ Barretts History"
dat.rna$sample_type[(dat.rna$morphology=="8140/3" |
                       dat.rna$morphology=="8480/3") &
                      dat.rna$SampleType_Level2=="Tumor" &
                      dat.rna$Barrett.s.Esophagus.Reported=="No"] <- "ESCA tissues w/o Barretts History"
...
dat.wgs$sample_type[(dat.wgs$morphology=="8140/3" |
                      ...
                      dat.wgs$Barrett.s.Esophagus.Reported=="Yes"] <- "ESCA tissues w/ Barretts History"
dat.wgs$sample_type[(dat.wgs$morphology=="8140/3" |
                       dat.wgs$morphology=="8480/3") &
                      dat.wgs$SampleType_Level2=="Tumor" &
                      dat.wgs$Barrett.s.Esophagus.Reported=="No"] <- "ESCA tissues w/o Barretts History"
dat.wgs$sample_type[(dat.wgs$morphology=="8140/3" | 
                       dat.wgs$morphology=="8480/3") &
                      dat.wgs$SampleType_Level2=="Normal"&
                      dat.wgs$Barrett.s.Esophagus.Reported=="Yes"] <- "ESCA-adjacent tissue w/ Barretts History"
...
plt_hmap1 <- ggplot(hmd, 
  ...
  geom_tile() +
  #facet_wrap(.~sample_type)+
  scale_fill_gradient2("Abundance",trans="sqrt", high=myColor[1], mid = myColor[50], low=myColor[100], midpoint = 0.005, breaks=c(0, 0.001, 0.01, 0.05, 0.10)) +
  scale_x_continuous(breaks = spd$x_center, 
                     labels = spd$ID, 
                     expand = c(0, 0)) + 
  # For the y axis, alternatively set the labels as: gene_position_table$gene
...
plt_hmap2 <- ggplot(hmd, 
  ...
  geom_tile() +
  #facet_wrap(.~sample_type)+
  scale_fill_gradient2("expr",trans="sqrt", high=myColor[1], mid = myColor[50], low=myColor[100], midpoint = 0.005, breaks=c(0, 0.001, 0.01, 0.05, 0.10)) +
  scale_x_continuous(breaks = spd$x_center, 
                     labels = spd$ID, 
                     expand = c(0, 0)) + 
  # For the y axis, alternatively set the labels as: gene_position_table$gene
...
dat.rna$ESCAcomp[(dat.rna$morphology=="8140/3" |
                   dat.rna$morphology=="8480/3") &
                  dat.rna$SampleType_Level2=="Normal" &
                  dat.rna$Barrett.s.Esophagus.Reported=="Yes"] <- "ESCA-adjacent tissues w/ Barretts History"
dat.rna$ESCAcomp[(dat.rna$morphology=="8140/3" |
                   dat.rna$morphology=="8480/3") &
                  dat.rna$SampleType_Level2=="Tumor" &
                  dat.rna$Barrett.s.Esophagus.Reported=="No"] <- "ESCA tissues w/o Barretts History"
...
dat.wgs$ESCAcomp[(dat.wgs$morphology=="8140/3" |
                       dat.wgs$morphology=="8480/3") &
                       dat.wgs$SampleType_Level2=="Normal" &
                       dat.wgs$Barrett.s.Esophagus.Reported=="Yes"] <- "ESCA-adjacent tissues w/ Barretts History"
