...
myColor <- colorRampPalette(c("#416DD4", "#565E6A", "#FFBC33"))(100)
...
plt_hmap1 <- ggplot(hmd, 
  ...
  scale_fill_gradient2("Abundance",trans="sqrt", high=myColor[1], low=myColor[2], breaks=c(0, 0.10, 0.30, 0.50, 0.80)) +
...
plt_hmap2 <- ggplot(hmd, 
  ...
  geom_tile() +
  #facet_wrap(.~sample_type)+
  scale_fill_gradient2("expr",trans="sqrt", high=myColor[1], low=myColor[2], breaks=c(0, 0.1, 0.10, 0.30, 0.50, 0.80)) +
  scale_x_continuous(breaks = spd$x_center, 
                     labels = spd$ID, 
                     expand = c(0, 0)) + 
  # For the y axis, alternatively set the labels as: gene_position_table$gene
...
if(save.plots == T){
  ggsave(paste0("output/slide-5-heatmap-05-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-5-heatmap-05-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
p
if(save.plots == T){
  ggsave(paste0("output/slide-5-heatmap-01-",save.Date,".pdf"), plot=p, units="in", width=11, height=7)
  ggsave(paste0("output/slide-5-heatmap-01-",save.Date,".png"), plot=p, units="in", width=11, height=7)
}
```
...
p
if(save.plots == T){
  ggsave(paste0("output/slide-5-heatmap-001-",save.Date,".pdf"), plot=p, units="in", width=11, height=10)
  ggsave(paste0("output/slide-5-heatmap-001-",save.Date,".png"), plot=p, units="in", width=11, height=10)
}
```
...
table(tcga_rna_sample_data$tissue)

table(tcga_rna_sample_data$RNAseq_Solid_Tissue_Normal)

table(tcga_rna_sample_data$Barrett.s.Esophagus.Reported)

table(tcga_rna_sample_data$tumor, tcga_rna_sample_data$Barrett.s.Esophagus.Reported)

nrow(tcga_rna_sample_data)
...
if(save.plots == T){
  ggsave(paste0("output/slide-6-heatmap-05-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-6-heatmap-05-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
if(save.plots == T){
  ggsave(paste0("output/slide-6-heatmap-01-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-6-heatmap-01-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
if(save.plots == T){
  ggsave(paste0("output/slide-6-heatmap-001-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-6-heatmap-001.-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
table(tcga_wgs_sample_data$tissue)
table(tcga_wgs_sample_data$WGS_Blood_Normal)
table(tcga_wgs_sample_data$WGS_Solid_Tissue_Normal)

table(tcga_wgs_sample_data$Barrett.s.Esophagus.Reported)

table(tcga_wgs_sample_data$tumor, tcga_wgs_sample_data$Barrett.s.Esophagus.Reported)

nrow(tcga_wgs_sample_data)
```
...
if(save.plots == T){
  ggsave(paste0("output/slide-7-heatmap-05-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-7-heatmap-05-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
if(save.plots == T){
  ggsave(paste0("output/slide-7-heatmap-01-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-7-heatmap-01-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
if(save.plots == T){
  ggsave(paste0("output/slide-7-heatmap-001-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-7-heatmap-001-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
if(save.plots == T){
  ggsave(paste0("output/slide-8-heatmap-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-8-heatmap-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
...
plt_hmap2 <- ggplot(hmd, 
  ...
  geom_tile() +
  #facet_wrap(.~sample_type)+
  scale_fill_gradient2("expr",trans="sqrt", high=myColor[1], low=myColor[2], breaks=c(0, 0.10, 0.30, 0.50, 0.80)) +
  scale_x_continuous(breaks = spd$x_center, 
                     labels = spd$ID, 
                     expand = c(0, 0)) + 
  # For the y axis, alternatively set the labels as: gene_position_table$gene
...
if(save.plots == T){
  ggsave(paste0("output/slide-9-heatmap-",save.Date,".pdf"), plot=p, units="in", width=11, height=5)
  ggsave(paste0("output/slide-9-heatmap-",save.Date,".png"), plot=p, units="in", width=11, height=5)
}
```
