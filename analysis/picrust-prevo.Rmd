---
title: "PICRUSt Stratified Analyses - Prevotella spp. (genus level only)"
output:
...
p
ggsave("output/updated-figures-2021-05-20/picrust-prevo-EC.pdf",p,units="in", height=12, width=10)
```
...
p
#ggsave("output/updated-figures-2021-05-20/picrust-prevo-KO.pdf",p,units="in", height=12, width=10)
```
