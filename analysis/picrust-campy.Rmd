...
subtitle: "Campylobacter concisus"
output:
...
p
ggsave("output/updated-figures-2021-05-20/picrust-campy-EC.pdf",p,units="in", height=12, width=10)
```
...
```{r ec-corplot, warning=F, error=F, message=F, fig.dim=c(7,5), out.height="400px", out.width="90%"}
...
```{r ec-glm-overview, warning=F, error=F, message=F, fig.dim=c(7,5), out.height="400px", out.width="90%"}
...
p
ggsave("output/updated-figures-2021-05-20/picrust-campy-KO.pdf",p,units="in", height=12, width=10)
```
...
```{r ko-corplot, warning=F, error=F, message=F, fig.dim=c(7,5), out.height="400px", out.width="90%"}
...
```{r ko-glm-overview, warning=F, error=F, message=F, fig.dim=c(7,5), out.height="400px", out.width="90%"}
